...
//        	    result.put(rsmd.getColumnName(i), rs.getTimestamp(i));
        	    result.put(rsmd.getColumnLabel(i), rs.getTimestamp(i));
        	    break;
        	case Types.TIME: // 如果是时间类型
//        	    result.put(rsmd.getColumnName(i), rs.getTime(i));
        	    result.put(rsmd.getColumnLabel(i), rs.getTime(i));
        	    break;
        	case Types.DATE: // 如果是时间类型
//        	    result.put(rsmd.getColumnName(i), rs.getDate(i));
        	    result.put(rsmd.getColumnLabel(i), rs.getDate(i));
        	    break;
